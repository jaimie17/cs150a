...
public class SymbolTableVisitor implements Visitor {
  ...
  public Object visit(ClassDecl node, Object data){ 
    ...
    String className = data + "$" + i.s;
    node.i.accept(this, data);
    node.v.accept(this, className);
    node.m.accept(this, className);
    symbolTable.classes.put(className, node);
  ...
  public Object visit(False node, Object data){ 
    ...
    public Object visit(MainClass node, Object data){ 
        ...
        symbolTable.mainClass.put(data + "$" + i.s, node);
